...
app.use(express.static(path.join(__dirname, '..', '..', 'ui', 'frontend', 'menus')));

app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, '..', '..', 'ui', 'frontend', 'menus', 'menu.html'));
});

app.get('/MenuComponent.js', (req, res) => {
    res.sendFile(path.join(__dirname, '..', '..', 'ui', 'frontend', 'menus', 'MenuComponent.js'));
});
